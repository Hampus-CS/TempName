...
public class UIManager : MonoBehaviour
{
    ...
    public Player player; // Assign your Player GameObject in Inspector
    ...
    {
        player.SavePlayerPosition(slot);
        CheckSavesAndUpdateUI();
    }
    ...
    public void LoadPlayerSave(int saveSlot)
    {
        ...
        try
        {
            ...
            player.transform.position = loadedSave.saveData.position; // Make sure Player has a public method or variable for setting position if needed
        }
        catch (Exception ex)
        {
